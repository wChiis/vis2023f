...
__query(FileAttachment("artistVer (1) - artistVer (1)@1.csv"),{from:{table:"artistVer (1) - artistVer (1)"},sort:[],slice:{to:null,from:null},filter:[],select:{columns:null}},invalidation)
)}

function _artistpublic(__query,FileAttachment,invalidation){return(
__query(FileAttachment("artistPublic (1) - artistPublic (1)@1.csv"),{from:{table:"artistPublic (1) - artistPublic (1)"},sort:[],slice:{to:null,from:null},filter:[],select:{columns:null}},invalidation)
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["artistPublic (1) - artistPublic (1)@1.csv", {url: new URL("./artistPublic (1) - artistPublic (1).csv", import.meta.url), mimeType: "text/csv", toString}],
    ["artistVer (1) - artistVer (1)@1.csv", {url: new URL("./artistVer (1) - artistVer (1).csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
